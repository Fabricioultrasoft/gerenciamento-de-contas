...
namespace Gerenciamento_de_Contas
{
    class DadosProjecoesReceber
    {
        ...
        //SQL strings
        string strInsert = "INSERT INTO Projecoes_Receber (mes, valor) VALUES (@mes, @valor)";
        string strDelete = "DELETE FROM Projecoes_Receber WHERE mes = @mes";
        string strUpdate = "UPDATE Projecoes_Receber SET valor = @valor WHERE mes = @mes";
