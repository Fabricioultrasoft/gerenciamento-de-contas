...
{
    public partial class frm_pesquisaRapidaReceita2 : Form
    {
        public frm_pesquisaRapidaReceita2()
        {
            InitializeComponent();
        }
        ...
        public frm_pesquisaRapidaReceita2(string valor2, string tipo2)
        {
            this.valor = valor2;
            this.tipo = tipo2;
        }
        ...
        private void frm_pesquisaRapidaReceita2_Load(object sender, EventArgs e)
        {
